...
@Component({
  selector: 'app-crud-master-detail',
  templateUrl: './crud-master-detail.component.html',
  styleUrls: ['./crud-master-detail.component.scss']
})
export class CrudMasterDetailComponent implements OnInit {
  employees: Employee[];
